...
public interface ForumRepository extends JpaRepository<Forum, Long> {
    ...
    @Query("SELECT b FROM Forum b LEFT JOIN FETCH b.threads t GROUP BY b ORDER BY COUNT(t) DESC")
    ...
    @Query("SELECT COUNT(p) FROM Comment p WHERE p.thread.board = :board")
